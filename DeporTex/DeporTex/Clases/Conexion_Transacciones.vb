Public Class Conexion_Transacciones
    Enum tipo_conexion
        simple
        transaccion
    End Enum
    ...
    Dim cadena_conexion As String = "Provider=SQLNCLI11;Data Source=LAPTOP-VLNG4BCV\SQLEXPRESS;Integrated Security=SSPI;Initial Catalog=_DB_DEPORTEX"
